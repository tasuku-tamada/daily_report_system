...
public class AttendanceValidator {
    public static List<String> validate(Attendance a,Employee employee) {
        List<String> errors = new ArrayList<String>();

        String date_error = _validateDate(a.getDate(),employee,a);
    ...
    // 日付
    private static String _validateDate(Date date,Employee employee,Attendance a) {
        // 必須入力チェック
